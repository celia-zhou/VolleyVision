...
class NewGenerateStatsForm extends React.Component {
    ...
    addStats = e => {
        ...
        const statsRef = addDoc(collection(db, 'users/'+currUser.uid+'/matches/HL782UkPnHhBcuSlhppIeMKlnLj2/stats'), { 
    ...
    return (
        ...
        <div>
            <VidContainer>
                <ImageList sx={{ position: 'absolute', top: 150, left: 100, width: 2000, height: 1100, bgcolor:"#DBEBFB"}} cols={3}>
                {itemData.map((item) => (
